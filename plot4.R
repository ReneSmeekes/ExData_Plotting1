...
plot(pcn$Time, pcn$Global_active_power, type="l", xlab="", ylab="Global Active Power")
...
plot(pcn$Time, pcn$Voltage, type="l", xlab="datetime", ylab="Voltage")

plot(pcn$Time, pcn$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
